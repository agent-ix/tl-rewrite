...
| TC-039 | Enforce one scoped registry ix-flow specification across executable npm install arguments; reject alternate or non-literal package-spec families and automatic triggers; ignore inert YAML metadata/comments; verify the exact released runtime version | Integration | P0 | NFR-003-AC-7, NFR-003-AC-8, NFR-003-AC-9, NFR-003-AC-10, NFR-003-AC-11, NFR-003-AC-12 | 🚧 planned correction |
