...
| TC-039 | Enforce one scoped registry ix-flow specification across executable npm install/i/add arguments in YAML run scripts; reject alternate or non-literal families and automatic triggers; ignore inert metadata and true YAML/shell comments; verify the exact runtime | Integration | P0 | NFR-003-AC-7, NFR-003-AC-8, NFR-003-AC-9, NFR-003-AC-10, NFR-003-AC-11, NFR-003-AC-12 | ✅ implemented |
