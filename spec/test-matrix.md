...
| TC-039 | Enforce one scoped registry ix-flow specification across semantic job-step run scalars, the complete documented npm-install alias family, and literal nested shell commands; reject alternate/non-literal families and automatic triggers; ignore inert YAML metadata and true comments; verify the exact runtime | Integration | P0 | NFR-003-AC-7, NFR-003-AC-8, NFR-003-AC-9, NFR-003-AC-10, NFR-003-AC-11, NFR-003-AC-12 | ✅ implemented |
