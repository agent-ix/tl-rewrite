...
| NFR-004-AC-8 | The repository's README, `CLAUDE.md`, and any hosted workflow dispatch that runs the full local gate set invoke the entry point rather than a bare `make ci`. | Inspection (TC-065) |
