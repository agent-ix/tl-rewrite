...
Catalog serialization, rewrite execution, replay, equivalence enumeration,
context binding, and evidence are in scope.
...
|---|---|---|
| NFR-001-AC-1 | Repeated catalog, rewrite, replay, conformance, context binding, and serialization operations are byte-for-byte stable. | Test (TC-004, TC-005, TC-017, TC-031, TC-035) |
