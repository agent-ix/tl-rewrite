...
| FR-002-AC-2 | Every configured budget, nondegenerate reachable-graph boundary, and repeated complete state fails explicitly without a successful normalization claim. | Test (TC-006, TC-007, TC-020) |
