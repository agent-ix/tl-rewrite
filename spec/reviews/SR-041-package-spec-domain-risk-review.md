...
Technical risk is medium and volatility is medium: npm package-spec syntax and
...
| --- | --- | --- | --- | --- |
| NFR-003-AC-7/8/12 | Medium | Medium | npm specs plus YAML/shell token boundaries | Fail-closed classifier and per-family mutation table |
