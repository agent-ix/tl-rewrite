...
| FND-3603 | high | **FIXED after exact-head review:** the reviewed implementation collapsed YAML and shell comment grammars, omitted quoted `run` keys, and omitted npm `add`. AC-7, AC-9, AC-12, and TC-039 now state and cover those boundaries explicitly. | NFR-003-AC-7, NFR-003-AC-9, NFR-003-AC-12, TC-039, tl-rewrite#34 review |
...
- TC-039 names normal, alternate-family, duplicate, non-literal, inert-metadata,
  trigger, and runtime outcomes and is implemented with the corrective probes.
